    ...
    setSourceBlocks = (data, tooltips) => {
        ...
        for (let i = 0; i < this.expandableBlocks.length; ++i) {
            ...
            if (this.expandableBlockTooltips && this.expandableBlockTooltips.length > i) {
                ...
                newBlock.onmouseover = () => {
                    if (newBlock.parentNode.classList.contains('drag-area')) {
                        const parsonsTooltipEvent = {
        ...
        for (let i = 0; i < data.length; ++i) {
            ...
            newBlock.onclick = () => {
                ...
                if (newBlock.parentNode.classList.contains('drop-area')) {
        ...
        this._dropSortable = new Sortable(this._dropArea, {
            ...
            onAdd: (event) => {
                ...
                if (isExpandable) {
                    ...
                    this._getBlockPosition(event.item);
